...
/**
 * Helper function to parse "08:00AM" / "05:00PM" or so.
 * Returns a Date object or null if invalid.
 * Adjust the parsing logic as needed for your actual format.
 */
function parseTime(timeStr: string): Date | null {
    // e.g. "08:00AM", "05:00PM", etc.
    if (timeStr === "-" || !timeStr) return null

    // We'll assume the format: HH:MMAM or HH:MMPM (12-hour clock)
    // Extract the numeric part (HH:MM) and the AM/PM suffix
    ...
    // Create a Date just for the time portion
    const date = new Date()
...
/**
 * Decide the Day & Status from clockIn/clockOut
 */
