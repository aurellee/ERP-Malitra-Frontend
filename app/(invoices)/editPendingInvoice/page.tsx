...
export default function EditPendingInvoice() {
    ...
    const handleUpdateInvoice = async () => {
        try {
            ...
            console.log("Sales:", payload.sales);
                        ...
                        <div className="space-y-8 mt-4 ">
                            ...
                            <div className="items-center">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => {
                                        handleFormChange("car_number", e.target.value);
                                        setUnsavedChanges(true);
                                    }}
                            ...
                            <div>
                                ...
                                bg-gray-100 dark:bg-[#2a2a2a] cursor-not-allowed text-gray-500">
                                    {isLoadingForm ? (
                                        ...
                                        <span>
                                            {form.selectedSalesId && empMap[form.selectedSalesId]
                            ...
                            <div>
                                ...
                                bg-gray-100 dark:bg-[#2a2a2a] cursor-not-allowed text-gray-500">
                                    {isLoadingForm ? (
                                        ...
                                        <span>
                                            {form.selectedMechanicId && empMap[form.selectedMechanicId]
